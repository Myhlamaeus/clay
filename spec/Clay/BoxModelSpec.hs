...
spec = do
  ...
  describe "scrollPadding" $ do
    testDirectionalDefault scrollPadding (px 1) (px 2) (px 3) (px 4)
      ...
      "{scroll-padding-right:2px;scroll-padding-left:2px}"
      "{scroll-padding:1px 4px 3px 2px}"
      "{scroll-padding-top:1px;scroll-padding-left:1px}"
      "{scroll-padding-right:3px;scroll-padding-bottom:3px}"
  ...
  describe "scrollMargin" $ do
    testDirectionalDefault scrollMargin (px 1) (px 2) (px 3) (px 4)
      ...
      "{scroll-margin-right:2px;scroll-margin-left:2px}"
      "{scroll-margin:1px 4px 3px 2px}"
      "{scroll-margin-top:1px;scroll-margin-left:1px}"
      "{scroll-margin-right:3px;scroll-margin-bottom:3px}"
  ...
  describe "posInset" $ do
    testDirectionalDefault posInset (px 1) (px 2) (px 3) (px 4)
      ...
      "{top:1px;bottom:1px}"
      "{right:2px;left:2px}"
      "{top:1px;right:4px;bottom:3px;left:2px}"
      "{top:1px;left:1px}"
  ...
  describe "border" $ do
    testDirectionalDefault border (mkBorder (px 1) solid red) (mkBorder (px 2) dotted green) (mkBorder (px 3) dashed blue) (mkBorder (px 4) double yellow)
      ...
      "{border-top:1px solid #ff0000;border-right:2px dotted #008000;border-bottom:1px solid #ff0000;border-left:2px dotted #008000}"
      "{border-top:1px solid #ff0000;border-bottom:1px solid #ff0000}"
      "{border-right:2px dotted #008000;border-left:2px dotted #008000}"
      "{border-top:1px solid #ff0000;border-right:4px double #ffff00;border-bottom:3px dashed #0000ff;border-left:2px dotted #008000}"
      "{border-top:1px solid #ff0000;border-left:1px solid #ff0000}"
      "{border-right:3px dashed #0000ff;border-bottom:3px dashed #0000ff}"
